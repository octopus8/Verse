...
namespace O8C.WebGL {
    ...
    public class WebXRControllerLeft : InputDevice {
        ...
        public static void Initialize() {
            InputSystem.RegisterLayout<WebXRControllerLeft>(
                matches: new InputDeviceMatcher()
                    .WithInterface("WebXRControllerLeft"));

            var device = InputSystem.devices.FirstOrDefault(x => x is WebXRControllerLeft);
            if (device == null) {
                InputSystem.AddDevice(new InputDeviceDescription {
                    interfaceName = "WebXRControllerLeft",
                    product = "WebXRControllerLeft",
                });
            }
        }
        ...
        /// <summary>
        /// Adds a menu item to add a left controller.
        /// </summary>
        [MenuItem("Tools/Add Left WebXRController")]
        ...
        /// </remarks>
        [MenuItem("Tools/Remove Left WebXRController")]
