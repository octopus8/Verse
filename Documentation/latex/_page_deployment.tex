\hypertarget{_page_deployment_SectionServer}{}\doxysection{Server}\label{_page_deployment_SectionServer}
\hypertarget{_page_deployment_SubsectionBuild}{}\doxysubsection{1. Building}\label{_page_deployment_SubsectionBuild}
...
\end{DoxyItemize}
\end{DoxyEnumerate}\hypertarget{_page_deployment_SectionUpload}{}\doxysubsection{2. Uploading}\label{_page_deployment_SectionUpload}
...
\end{DoxyEnumerate}\hypertarget{_page_deployment_SectionUsefulBashCommands}{}\doxysection{Useful Server Commands}\label{_page_deployment_SectionUsefulBashCommands}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{_page_deployment_SectionUsefulADBCommands}{}\doxysection{Useful ADB Commands}\label{_page_deployment_SectionUsefulADBCommands}
